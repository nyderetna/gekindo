...
-- Dumping data for table gekindo.kategori_pelayanan: ~0 rows (approximately)
...
INSERT INTO `pelayan` (`id_pelayan`, `slug`, `gelar_pelayan`, `gelar_depan_pelayan`, `nama_pelayan`, `jabatan_pelayan`, `img`, `singkatan_jabatan`) VALUES
	(1, 'elliot-labonda', 'S.Th., M.Teol.,', NULL, 'Elliot Nan Boland Labonda', 'Gembala Jemaat', 'enbl.png', 'Pdt.'),
	(2, 'emanuella-labonda', 'S.Th.,', NULL, 'Emanuella Labonda-Nenoharan', 'Pendeta', 'eln.png', 'Pdt.'),
	(3, 'yuliati-longgo', 'S.Th., M.Th.,', NULL, 'Yuliati Longgo', 'Pendeta', 'yl.png', 'Pdt.'),
	(4, 'adrian-ingratubun', 'MM.,', 'Ir.', 'Adrian Ingratubun', 'Penatua', 'ai.png', 'Pnt.'),
	(5, 'ratna-sinaga', NULL, NULL, 'Ratna Sinaga', 'Penatua', 'rs.png', 'Pnt.'),
	(6, 'restiana-tampubolon', NULL, NULL, 'Restiana Tampubolon', 'Penatua', 'rt.png', 'Pnt.'),
	(7, 'ros-rahayaan', NULL, NULL, 'Ros Rahayaan', 'Penatua', 'rr.png', 'Pnt.'),
	(8, 'widarti-napitupulu', 'S.E.,', NULL, 'Widarti Napitupulu', 'Diaken', 'wn.png', 'Dkn.'),
	(9, 'fyka-napitupulu', 'S.S.,', NULL, 'Fyka Napitupulu', 'Diaken', 'fnm.png', 'Dkn.'),
	(10, 'agustina-retraubun', 'S.E.,', NULL, 'Agustina Retraubun', 'Diaken', 'arl.png', 'Dkn.'),
	(11, 'daniel-retraubun', 'S.T.,', NULL, 'Daniel Retraubun', 'Diaken', 'dpr.png', 'Dkn.');
...
-- Dumping data for table gekindo.pelayanan: ~0 rows (approximately)
